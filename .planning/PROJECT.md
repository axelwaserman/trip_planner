...
---
*Last updated: 2026-05-17 after Phase 4.4 completion — MockLLM fixture (`BaseChatModel` subclass) + 4 locked tests; custom pytest markers (`unit`, `integration`, `e2e`, `slow`) removed; test selection is path-only. REQ-mock-chat-tests moved Active → Validated.*
