...
Implements :class:`app.llm.protocol.LLMProvider` via duck typing. Replaces the
...
class OpenAIProvider:
    ...
    Structurally implements :class:`app.llm.protocol.LLMProvider` (duck typed —
    no inheritance). Constructed by :class:`app.llm.factory.LLMProviderFactory`;
    ...
    def bind_tools(self, tools: Sequence[BaseTool]) -> BoundProvider:
        ...
        # this Runnable structurally satisfies BoundProvider (ainvoke + astream),
        # but mypy cannot verify duck typing across third-party Runnable generics.
